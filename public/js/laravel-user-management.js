      ...
      \*************************************************/
        ...
        $(function () {
                ...
                var dt_user = dt_user_table.DataTable({
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            targets: 5,
                            render: function render(data, type, full, meta) {
                                var $lansudung = full['lansudung'];
                                return '<span class="user-email">' + $lansudung + '</span>';
                            }
                        },
                        {
                            // Actions
                    ...
                    buttons: [
                        {
                            ...
                            text: '<i class="ti ti-logout rotate-n90 me-2"></i>Xuất',
                            buttons: [
                                {
                                    extend: 'print',
                                    title: 'Users',
                        ...
                        {
                            text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Thêm người dùng</span>',
            ...
            $(document).on('click', '.edit-record', function () {
                ...
                $('#offcanvasAddUserLabel').html('Sửa người dùng');
                ...
                $.get(''.concat(baseUrl, 'user-list/').concat(user_id, '/edit'), function (data) {
                    ...
                    $('#lansudung').val(data.lansudung);
                    $('#add-user-password').val(data.password);
                });
            });
            ...
            $('.add-new').on('click', function () {
                ...
                $('#offcanvasAddUserLabel').html('Thêm người dùng');
            });
                ...
                $.ajax({
                    ...
                    error: function error(err) {
                        ...
                        Swal.fire({
                            ...
                            text: 'Email không được trùng nhau, vui lòng tạo email mới.',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success'
                            }
