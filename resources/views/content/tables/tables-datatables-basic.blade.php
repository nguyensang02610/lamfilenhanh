...
@section('content')
    ...
    <div class="offcanvas offcanvas-end" id="add-new-record">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title" id="exampleModalLabel">Thêm dữ liệu</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body flex-grow-1">
            <form class="add-new-record pt-0 row g-2" id="form-add-new-record" onsubmit="return false">
                <div class="col-sm-12">
                    <label class="form-label" for="basicFullname">Mã hình</label>
                ...
                <div class="col-sm-12">
                    <label class="form-label" for="basicPost">Dòng máy</label>
                    <div class="input-group input-group-merge">
                ...
                <div class="col-sm-12">
                    <label class="form-label" for="basicEmail">Ghi chú ( không bắt buộc )</label>
                    <div class="input-group input-group-merge">
